...
<%@page import="in.co.sunrays.wsx.controller.StaffListCtl"%>
...
<form action="<%=ORSView.STAFF_LIST_CTL%>">
	<center>
		<br>
		<p>
			<font class="textPMWithOutBorderCommonCenterRedBoldUnderline">Trainer
				List</font>
		</p>
		...
		<table cellspacing="0" style="border: 0px solid gray;" width="90%">
			<tr>
				...
				<td class="label" height="22" style="border: 0px solid gray;"
					...
					class="button" value="<%=StaffCtl.OP_NEXT%>"></td>
			</tr>
		</table>
