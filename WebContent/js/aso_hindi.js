...
stm_aix("p0i1","p0i0",[0," रिक्रूटमेंट / अपायंटमेंट","","",-1,-1,0,"","_self","","","","",0,0,0,"","",16,9,0,0,1,"#9cc2c9",0,"#b28800"],80,0);
stm_bpx("p2","p1",[]);
...
stm_aix("p2i3","p1i0",[0," रिक्रूटमेंट रिपोर्ट","","",-1,-1,0,"displayRecruitmentReport.do"],180,0);
stm_aix("p2i4","p1i0",[0," नये कर्मचारी की नियुक्ति","","",-1,-1,0,"displayAppointment.do"],180,0);
stm_aix("p2i5","p2i0",[0," समस्त कर्मचारियोंका प्रोफाइल देखिए ","","",-1,-1,0,"displayEmployeeList.do"],180,0);
stm_ep();

stm_aix("p0i2","p0i0",[0," शिफ्ट","","",-1,-1,0,"","_self","","","","",0,0,0,"","",16,9,0,0,1,"#9cc2c9",0,"#6b0046"],80,0);
stm_bpx("p3","p1",[]);
stm_aix("p3i0","p2i0",[0," सभी को शिफ्ट अलोकेट करें","","",-1,-1,0,"displayShiftAllocation.do"],180,0);
stm_aix("p3i1","p2i0",[0," सूपरवाइज़र को शिफ्ट अलोकेट करें","","",-1,-1,0,"displayShiftAllocationToSupervisorAction.do"],180,0);
stm_aix("p3i2","p1i0",[0," ओटी अलोकेशन","","",-1,-1,0,"displayShiftAllocationReport.do","_self","","","","",0,0,0,"","",0,0,0,0,1,"#FFFFFF",0,"#a81515"],180,0);
...
stm_aix("p0i4","p0i0",[0," मेरी शिफ्ट","","",-1,-1,0,"displayShiftReportAction.do?lookShift=0","_self","","","","",0,0,0,"","",16,9,0,0,1,"#a84200",0,"#005591"],0,25);
...
stm_aix("p0i7","p0i4",[0," मेरा ई.पी.एफ.","","",-1,-1,0,"displayEpf6AFormAction.do?principalEmployerLocationId=0"],0,25);
...
stm_aix("p6i2","p6i0",[0," पासवर्ड बदलें","","",-1,-1,0,"displayChangePassword.do"],0,4);
stm_ep();
stm_ep();
stm_em();
