...
if(dd.obj.src==document.getElementById('submitImage').value)
{
var temp=confirm("Do You Really Want To Save The Letter Head Format ?");

if(temp==true)
{
document.getElementById('form1').action=document.getElementById('basePath').value+"submitLetterHeadFormInsert.do?javascript=true";
