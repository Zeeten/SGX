...
stm_ep();
stm_aix("p8i5","p2i0",[0," प्रोफाइल देखिए","","",-1,-1,0,""]);
stm_bpx("p8","p1",[1,2,0,0,0,0,0,0]);
...
stm_aix("p8i2","p2i0",[0," प्रोफाइल तलाश","","",-1,-1,0,"displayCharacterVerificationEmployeeSearch.do?operation=Search"]);
...
stm_bpx("p5","p2",[]);
stm_aix("p5i0","p2i0",[0," नया एक्सेपटेन्स","","",-1,-1,0,"displaySelectLocationIndustry.do?hiddenOperation=Add"],250,0);
stm_aix("p5i1","p2i0",[0," नये डेसिग्नेशन से चालू एक्सेपटेन्स तक ","","",-1,-1,0,"displaySelectLocationIndustry.do?hiddenOperation=AddNew"],250,0);
stm_ep();
...
stm_bpx("p7","p6",[]);
stm_aix("p7i0","p2i0",[0," सर्विस प्रोवायडर को फ़ॉरवर्ड","","",-1,-1,0,"displaySelectLocationAndIndustryForAgreement.do?hiddenOperation=Add","_self","","","","",0,0,0,"","",0,0,0,0,1,"#FFFFFF",0,"#6b0046"],150,0);
stm_aix("p7i1","p7i0",[0," सर्विस प्रोवायडर से फ़ॉरवर्ड","","",-1,-1,0,"displayAgreementSampleFwdBySE.do?hiddenOperation=SelectAgreementFwdBySE"],150,0);
...
stm_bpx("p12","p6",[]);
stm_aix("p12i0","p10i0",[0," उपस्थिति रिपोर्ट देखिए","","",-1,-1,0,"displayAttendanceReportByAgency.do","_self","","","","",0,0,0,"","",0,0]);
...
stm_aix("p12i5","p12i0",[0," ऑल","","",-1,-1,0,"displayViewTheListOfPrincipalEmployerAction.do"]);
stm_aix("p12i6","p12i0",[0," आने तथा जाने का समय देखिए","","",-1,-1,0,"displayInAndOutTimeAction.do"]);
stm_ep();
//stm_aix("p0i7","p0i6",[0,"सहायता"]);
...
stm_aix("p13i2","p13i0",[0," पासवर्ड बदलें","","",-1,-1,0,"displayChangePassword.do"]);
stm_ep();
stm_ep();
stm_em();
