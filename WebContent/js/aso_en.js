...
stm_aix("p1i0","p0i0",[0,"Add","","",-1,-1,0,"displayListForSSByASODelegate.do?hiddenOperation=insert","_self","","","","",0,0,0,"","",0,0,0,0,1,"#FFFFFF",0,"#b28800",0,"","",3,3,1,1,"#95C5D8","#CFE9F4","#003399","#FFFFFF"," 8pt Verdana","8pt Verdana"],80,0);
stm_aix("p1i1","p1i0",[0,"Update","","",-1,-1,0,"displayListForSSByASODelegate.do?hiddenOperation=update"],80,0);
stm_aix("p1i2","p1i0",[0,"View","","",-1,-1,0,"displayListForSSByASODelegateView.do?hiddenOperation=view"],80,0);
stm_ep();
...
stm_bpx("p3","p1",[1,4]);
stm_aix("p3i0","p2i0",[0,"Shift Allocation To All","","",-1,-1,0,"displayShiftAllocation.do"],180,0);
stm_aix("p3i1","p2i0",[0,"Shift Allocation To Supervisor","","",-1,-1,0,"displayShiftAllocationToSupervisorAction.do"],180,0);
stm_aix("p3i2","p1i0",[0,"OT Allocation","","",-1,-1,0,"displayShiftAllocationReport.do","_self","","","","",0,0,0,"","",0,0,0,0,1,"#FFFFFF",0,"#a81515"],180,0);
stm_aix("p3i3","p3i2",[0,"Shift Report","","",-1,-1,0,"displayShiftReportAction.do?lookShift=1"],180,0);
stm_aix("p3i4","p3i2",[0,"Update Shift","","",-1,-1,0,"displayUpdateAllocatedShift.do"],180,0);
stm_ep();
...
stm_aix("p4i3","p4i2",[0,"Upload Attendance","","",-1,-1,0,""],130,0);
stm_bpx("p4","p1",[]);
stm_aix("p4i0","p1i0",[0," By B-One","","",-1,-1,0,"http://localhost:8080/UploadProject/Report.jsp"]);
stm_aix("p4i1","p1i0",[0," By Just Look","","",-1,-1,0,"displayUploadAttendanceByJustLook.do"]);
stm_ep();
stm_ep();

stm_aix("p0i4","p0i0",[0,"My Shift","","",-1,-1,0,"displayShiftReportAction.do?lookShift=0","_self","","","","",0,0,0,"","",16,9,0,0,1,"#a84200",0,"#005591"],0,25);
...
stm_aix("p0i7","p0i4",[0,"MY EPF","","",-1,-1,0,"displayEpf6AFormAction.do?principalEmployerLocationId=0"],0,25);
stm_aix("p0i8","p0i4",[0,"MY ESIC","","",-1,-1,0,""],80,0);
stm_aix("p0i9","p0i2",[0,"Logs"],80,0);
stm_bpx("p6","p1",[1,4]);
stm_aix("p6i0","p4i1",[0,"LogOut","","",-1,-1,0,"displayLoginAction.do?operation=LogOut"],0,4);
stm_aix("p6i1","p6i0",[0,"Home Page","","",-1,-1,0,"displayHomePage.do"],0,4);
stm_aix("p6i2","p6i0",[0,"Change Password","","",-1,-1,0,"displayChangePassword.do"],0,4);
stm_ep();
stm_ep();
stm_em();
