...
stm_bpx("p3","p1",[]);
stm_aix("p3i0","p2i0",[0," सर्वाना आवंटन्यात आलेली शिफ्ट","","",-1,-1,0,"displayShiftAllocation.do"],160,0);
stm_aix("p3i1","p2i0",[0," सूपरवाइज़रला आवंटन्यात आलेली शिफ्ट","","",-1,-1,0,""],160,0);
stm_aix("p3i2","p1i0",[0," ओटी आवंटन","","",-1,-1,0,"displayShiftAllocationReport.do","_self","","","","",0,0,0,"","",0,0,0,0,1,"#FFFFFF",0,"#a81515"],160,0);
stm_aix("p3i3","p3i2",[0," शिफ्ट रिपोर्ट","","",-1,-1,0,"displayShiftReportAction.do?lookShift=1"],160,0);
stm_aix("p3i4","p3i2",[0," शिफ्ट अपडेट","","",-1,-1,0,"displayUpdateAllocatedShift.do"],160,0);
stm_ep();
...
stm_aix("p4i2","p4i1",[0," अपलोड उपस्थिति","","",-1,-1,0,"http://localhost:8080/UploadProject/Report.jsp"],130,0);
stm_ep();

stm_aix("p0i4","p0i0",[0," माझी शिफ्ट","","",-1,-1,0,"displayShiftReportAction.do?lookShift=0","_self","","","","",0,0,0,"","",0,0,0,0,1,"#a84200",0,"#005591"],80,0);
...
stm_aix("p0i7","p0i4",[0," माझे ई.पी.एफ.","","",-1,-1,0,"displayEpf6AFormAction.do?principalEmployerLocationId=0"],80,0);
...
stm_aix("p6i2","p6i0",[0," पासवर्ड बदला ","","",-1,-1,0,"displayChangePassword.do"],130,0);
stm_ep();
stm_ep();
stm_em();
