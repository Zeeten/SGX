...
public abstract class BaseCtl extends HttpServlet {
	...
	protected void setAccess(HttpServletRequest request) {
		...
		AccessUtility.setReadAccess(AppRole.GUEST + "" + AppRole.STAFF + ""
				+ AppRole.STUDENT + "" + AppRole.ADMIN + ""
				+ AppRole.SUPER_ADMIN  + "" + AppRole.PRINCIPAL_EMPLOYER + "" + AppRole.TRAINING_PROVIDER,request);

		AccessUtility.setWriteAccess(AppRole.GUEST + "" + AppRole.STAFF + ""
				+ AppRole.ADMIN + "" + AppRole.SUPER_ADMIN + "" + AppRole.PRINCIPAL_EMPLOYER + "" + AppRole.TRAINING_PROVIDER, request);

		AccessUtility.setAddAccess(AppRole.GUEST + "" + AppRole.STAFF + ""
				+ AppRole.ADMIN + "" + AppRole.SUPER_ADMIN + "" + AppRole.PRINCIPAL_EMPLOYER + "" + AppRole.TRAINING_PROVIDER, request);

		AccessUtility.setDeleteAccess("" + AppRole.ADMIN + ""
				+ AppRole.SUPER_ADMIN, request);
	}
