...
import in.co.sunrays.wsx.model.NoticeModel;
...
System.out.println("populateModel"+populateModel);
				if (populateModel != null) {
					...
					System.out.println("##################### College id is " +populateModel.getCollegeId() );
					
					UserFilterManager.setCollegeId(request,
							populateModel.getCollegeId());
					UserFilterManager.setOrganizationId(request,
							populateModel.getOrganizationId());
