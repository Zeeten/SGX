 ...
 */
public class SchedularStatusListCtl extends BaseCtl{
	/**
	 * Logger to log the messages.
	 */
	private static Logger log = Logger.getLogger(SchedularStatusListCtl.class);
	
	@Override
	protected void doGet(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {

		log.debug("SchedularStatusListCtl doGet Start");
		...
		log.debug("SchedularStatusListCtl doGet End");
	}
	...
	protected String getView() {
		return ORSView.SCHEDULARSTATUS_LIST_VIEW;
	}
