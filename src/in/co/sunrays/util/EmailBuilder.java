 ...
 */
 ...
 public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("Registration is successful at  WSX");
		msg.append("<H1>Hi! Greetings from  WSX!</H1>");
		msg.append("<P>Congratulations for registering on WSX! You can now access your WSX account online - anywhere, anytime and enjoy the flexibility to check the Student Details.</P>");
